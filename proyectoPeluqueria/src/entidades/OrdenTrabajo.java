...
//CON GIFTCard
    ...
    public OrdenTrabajo(Cliente cliente, Empleado empleado, LocalDate fecha_orden_trabajo, LocalTime hora_orden_trabajo, String servicios_orden_trabajo, String productos_orden_trabajo, int duracion_orden_trabajo, double costo_total_orden_trabajo, double descuentoGiftCard_orden_trabajo, Transaccion transaccion, boolean estado_orden_trabajo) {
        this.cliente = cliente;
        this.empleado = empleado;
        this.fecha_orden_trabajo = fecha_orden_trabajo;
        this.hora_orden_trabajo = hora_orden_trabajo;
...
// con id
    ...
    public OrdenTrabajo(int id_orden_trabajo, Cliente cliente, Empleado empleado, LocalDate fecha_orden_trabajo, LocalTime hora_orden_trabajo, String servicios_orden_trabajo, String productos_orden_trabajo, int duracion_orden_trabajo, double costo_total_orden_trabajo, double descuentoGiftCard_orden_trabajo, Transaccion transaccion, boolean estado_orden_trabajo) {
